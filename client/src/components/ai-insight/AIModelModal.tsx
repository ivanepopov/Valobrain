...
const AIModelModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
                <GlassBox className="p-8 border-purple-400/30">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-bold text-white">Add Custom Model</h3>
                        <button onClick={onClose} className="text-purple-300 hover:text-white" aria-label="Close modal">
                            <X className="w-6 h-6" />
                        </button>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-purple-200 text-xs font-medium uppercase mb-2">Agent Type</label>
                            <select
                                value={form.agent}
                        ...
                        <div>
                            <label className="block text-purple-200 text-xs font-medium uppercase mb-2">Display Name</label>
                            <input
                                type="text"
                                value={form.name}
                        ...
                        <div>
                            <label className="block text-purple-200 text-xs font-medium uppercase mb-2">Model ID</label>
                            <input
                                type="text"
                                value={form.modelId}
                        ...
                        <div>
                            <label className="block text-purple-200 text-xs font-medium uppercase mb-2">Custom Endpoint (Optional)</label>
                            <input
                                type="text"
                                value={form.endpoint}
                        ...
                        <button
                            ...
                            className="w-full py-3 mt-4 text-white font-bold rounded-xl hover:scale-[1.02] transition-transform"
                            style={{
