    ...
    <div className="space-y-8">
        ...
        <GlassBox>
            <div className="space-y-6">
                {/* Map Filter */}
                <div>
                    <label className="text-white text-sm mb-2 block">Filter by Map</label>
                ...
                {/* Timeframe Filter */}
                <div>
                    <label className="text-white text-sm mb-2 block">Filter by Timeframe</label>
                    <div className="flex gap-2 flex-wrap">
        ...
        {!scoutData ? (
            <GlassBox className="p-24 text-center">
                ...
                <p className="text-white/70 text-sm">No match records found for {selectedMap}</p>
                <button
                    onClick={() => {
                        setSelectedMap('All');
